...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getStudentRating($kc, $student)
        {
                        return \App\Services\KC\Kc::getStudentRating($kc, $student);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getStudentRatingInQuiz($kc, $student, $quiz)
        {
                        return \App\Services\KC\Kc::getStudentRatingInQuiz($kc, $student, $quiz);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getQuizErrorRate($kc, $quiz)
        {
                        return \App\Services\KC\Kc::getQuizErrorRate($kc, $quiz);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function fetchSplittable($course, $split_percentage)
        {
                        return \App\Services\KC\Kc::fetchSplittable($course, $split_percentage);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getStudentAwarenessInQuiz($student, $quiz)
        {
                        return \App\Services\KC\Kc::getStudentAwarenessInQuiz($student, $quiz);
        }
     ...
     */ 
        ...
        {
                        return \App\Services\Quiz\Quiz::hello();
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function createLeftOverStudents($quiz)
        {
                        return \App\Services\Quiz\Quiz::createLeftOverStudents($quiz);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getQuestionCorrectness($student, $question)
        {
                        return \App\Services\Quiz\Quiz::getQuestionCorrectness($student, $question);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getPassPercentage($quiz)
        {
                        return \App\Services\Quiz\Quiz::getPassPercentage($quiz);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getStudentScore($quiz, $student)
        {
                        return \App\Services\Quiz\Quiz::getStudentScore($quiz, $student);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getQuestionErrorRate($question)
        {
                        return \App\Services\Quiz\Quiz::getQuestionErrorRate($question);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getQuestionCorrectResponsesRate($question)
        {
                        return \App\Services\Quiz\Quiz::getQuestionCorrectResponsesRate($question);
        }
     ...
     *
     */ 
        class RichTextLaravelInstallCommand {
...
namespace  { 
            ...
            class KcFacade extends \App\Facades\KcFacade {}
            class QuizFacade extends \App\Facades\QuizFacade {}
