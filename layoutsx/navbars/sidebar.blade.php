            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('teacher.course') }}">
                        <i class="ni ni-planet text-blue"></i> {{ __('Course') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('teacher.students') }}">
                        <i class="ni ni-single-02 text-yellow"></i> {{ __('Students') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('teacher.quiz.index', ['course' => auth()->user()->teaches]) }}">
                        <i class="ni ni-bullet-list-67 text-red"></i> {{ __('Quizzes') }}
                    </a>
                </li>
                {{--
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('teacher.announcements') }}">
                        <i class="ni ni-bell-55 text-green"></i> {{ __('Announcements') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('teacher.grades') }}">
                        <i class="ni ni-collection text-orange"></i> {{ __('Grades') }}
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('student.assignments') }}">
                        <i class="ni ni-bullet-list-67 text-red"></i> {{ __('Assignments') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('student.announcements') }}">
                        <i class="ni ni-bell-55 text-green"></i> {{ __('Announcements') }}
                    </a>
                </li>
                <li class="nav-item">
