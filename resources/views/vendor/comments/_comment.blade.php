...
<div id="comment-{{ $comment->getKey() }}" class="media">
    ...
    <div class="media-body">
        <h5 class="mt-0 mb-1">{{ $comment->commenter->name ?? $comment->guest_name }} @if($model->teacher->name ==
            $comment->commenter->name)
            <div class="badge badge-secondary mr-1 mt-1">Teacher</div>
        ...
        @if($grouped_comments->has($comment->getKey()) && $indentationLevel <= $maxIndentationLevel) {{-- TODO: Don't
            repeat code. Extract to a new file and include it. --}} @foreach($grouped_comments[$comment->getKey()] as
            $child)
